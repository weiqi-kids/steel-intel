...
class UsSteelFetcher(CompanyFetcher):
    """U.S. Steel 爬蟲"""

    company_id = "us_steel"
    company_name = "U.S. Steel"
    news_url = "https://www.ussteel.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from U.S. Steel")
        return documents
