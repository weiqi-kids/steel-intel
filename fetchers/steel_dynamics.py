...
class SteelDynamicsFetcher(CompanyFetcher):
    """Steel Dynamics 爬蟲"""

    company_id = "steel_dynamics"
    company_name = "Steel Dynamics"
    news_url = "https://www.steeldynamics.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.steeldynamics.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Steel Dynamics")
        return documents
