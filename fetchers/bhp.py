...
class BhpFetcher(CompanyFetcher):
    """BHP Group 爬蟲"""

    company_id = "bhp"
    company_name = "BHP Group"
    news_url = "https://www.bhpgroup.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.bhpgroup.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from BHP Group")
        return documents
