...
class WarriorMetFetcher(CompanyFetcher):
    """Warrior Met Coal 爬蟲"""

    company_id = "warrior_met"
    company_name = "Warrior Met Coal"
    news_url = "https://www.warriormetcoal.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.warriormetcoal.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Warrior Met Coal")
        return documents
