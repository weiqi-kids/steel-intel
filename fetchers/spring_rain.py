...
class SpringRainFetcher(CompanyFetcher):
    """Spring Rain 爬蟲"""

    company_id = "spring_rain"
    company_name = "Spring Rain"
    news_url = "https://www.springrain.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.springrain.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Spring Rain")
        return documents
