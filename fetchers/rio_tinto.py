...
class RioTintoFetcher(CompanyFetcher):
    """Rio Tinto 爬蟲"""

    company_id = "rio_tinto"
    company_name = "Rio Tinto"
    news_url = "https://www.riotinto.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.riotinto.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Rio Tinto")
        return documents
