...
class BaosteelFetcher(CompanyFetcher):
    """Baoshan Steel 爬蟲"""

    company_id = "baosteel"
    company_name = "Baoshan Steel"
    news_url = "https://www.baoshansteel.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.baoshansteel.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Baoshan Steel")
        return documents
