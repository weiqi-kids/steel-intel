...
class JfeFetcher(CompanyFetcher):
    """JFE Holdings 爬蟲"""

    company_id = "jfe"
    company_name = "JFE Holdings"
    news_url = "https://www.jfeholdings.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.jfeholdings.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from JFE Holdings")
        return documents
