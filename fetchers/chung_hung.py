...
class ChungHungFetcher(CompanyFetcher):
    """Chung Hung Steel 爬蟲"""

    company_id = "chung_hung"
    company_name = "Chung Hung Steel"
    news_url = "https://www.chunghungsteel.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.chunghungsteel.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Chung Hung Steel")
        return documents
