...
class FortescueFetcher(CompanyFetcher):
    """Fortescue Ltd 爬蟲"""

    company_id = "fortescue"
    company_name = "Fortescue Ltd"
    news_url = "https://www.fortescueltd.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.fortescueltd.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Fortescue Ltd")
        return documents
