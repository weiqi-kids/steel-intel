...
class ClevelandCliffsFetcher(CompanyFetcher):
    """Cleveland-Cliffs 爬蟲"""

    company_id = "cleveland_cliffs"
    company_name = "Cleveland-Cliffs"
    news_url = "https://www.cleveland-cliffs.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.cleveland-cliffs.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Cleveland-Cliffs")
        return documents
...
if __name__ == "__main__":
    fetcher = ClevelandCliffsFetcher()
