...
class CmcFetcher(CompanyFetcher):
    """Commercial Metals 爬蟲"""

    company_id = "cmc"
    company_name = "Commercial Metals"
    news_url = "https://www.commercialmetals.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.commercialmetals.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Commercial Metals")
        return documents
