...
class TaChenFetcher(CompanyFetcher):
    """Ta Chen Stainless 爬蟲"""

    company_id = "ta_chen"
    company_name = "Ta Chen Stainless"
    news_url = "https://www.tachenstainless.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.tachenstainless.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Ta Chen Stainless")
        return documents
