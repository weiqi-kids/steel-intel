...
class TungHoFetcher(CompanyFetcher):
    """Tung Ho Steel 爬蟲"""

    company_id = "tung_ho"
    company_name = "Tung Ho Steel"
    news_url = "https://www.tunghosteel.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.tunghosteel.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Tung Ho Steel")
        return documents
