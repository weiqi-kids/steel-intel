...
class SuncokeFetcher(CompanyFetcher):
    """SunCoke Energy 爬蟲"""

    company_id = "suncoke"
    company_name = "SunCoke Energy"
    news_url = "https://www.suncokeenergy.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.suncokeenergy.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from SunCoke Energy")
        return documents
