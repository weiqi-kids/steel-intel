...
class RelianceFetcher(CompanyFetcher):
    """Reliance Inc 爬蟲"""

    company_id = "reliance"
    company_name = "Reliance Inc"
    news_url = "https://www.relianceinc.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.relianceinc.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Reliance Inc")
        return documents
