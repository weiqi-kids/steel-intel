...
class FengHsinFetcher(CompanyFetcher):
    """Feng Hsin Steel 爬蟲"""

    company_id = "feng_hsin"
    company_name = "Feng Hsin Steel"
    news_url = "https://www.fenghsinsteel.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.fenghsinsteel.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Feng Hsin Steel")
        return documents
