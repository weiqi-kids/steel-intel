...
class TataSteelFetcher(CompanyFetcher):
    """Tata Steel 爬蟲"""

    company_id = "tata_steel"
    company_name = "Tata Steel"
    news_url = "https://www.tatasteel.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.tatasteel.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Tata Steel")
        return documents
