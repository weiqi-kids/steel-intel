...
class TenarisFetcher(CompanyFetcher):
    """Tenaris 爬蟲"""

    company_id = "tenaris"
    company_name = "Tenaris"
    news_url = "https://www.tenaris.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Tenaris")
        return documents
