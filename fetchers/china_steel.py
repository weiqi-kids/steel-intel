...
class ChinaSteelFetcher(CompanyFetcher):
    """China Steel Corp 爬蟲"""

    company_id = "china_steel"
    company_name = "China Steel Corp"
    news_url = "https://www.chinasteelcorp.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.chinasteelcorp.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from China Steel Corp")
        return documents
