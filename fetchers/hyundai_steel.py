...
class HyundaiSteelFetcher(CompanyFetcher):
    """Hyundai Steel 爬蟲"""

    company_id = "hyundai_steel"
    company_name = "Hyundai Steel"
    news_url = "https://www.hyundaisteel.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.hyundaisteel.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Hyundai Steel")
        return documents
