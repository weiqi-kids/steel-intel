...
class NucorFetcher(CompanyFetcher):
    """Nucor 爬蟲"""

    company_id = "nucor"
    company_name = "Nucor"
    news_url = "https://www.nucor.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Nucor")
        return documents
